...
public class Playing extends JPanel implements ActionListener,KeyListener
{
    ...
    public void drawTarget(Graphics g){
        if(targetX!=-1){
            ...
            g.fillRect(targetX*Helper.cellWidth+Helper.fixWidth2(852), Helper.fixHeight2(60)+targetY*Helper.cellWidth, Helper.cellWidth, Helper.cellWidth);
    ...
    for(Ship ship:ships){
                ...
                g.fillRect(ship.getX()*Helper.cellWidth+Helper.fixWidth2(85),Helper.fixHeight2(61)+Helper.cellWidth*ship.getY(),-2+Helper.cellWidth*(ship.isHorizontal()?ship.getLength():1),-2+Helper.cellWidth*(ship.isHorizontal()?1:ship.getLength()));
                g.setColor(Color.BLACK);
            }
        }
    }
