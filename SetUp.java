...
public class SetUp extends JPanel implements ActionListener,KeyListener
{
    ...
    public void actionPerformed(ActionEvent e){
        if(e.getSource()==timer){
            ...
            new Playing(grid,isClient,server,nameField.getText(),frame);
                ...
                if(key.equals("Enter")){
                    ...
                    if(isValidPlacement()){
                        ...
                        while(!isValidPlacement()){
                            targetX++;
                            if(targetX==9&&targetY==9){targetX=0; targetY=0; horizontal=false;}
                            else if(targetX==9){targetX=0; targetY++;}
