...
public class Helper {
	...
	static {
		try {
			...
			titleFont = Font.createFont(Font.TRUETYPE_FONT, new File("Pixellari.ttf"))
					.deriveFont((float) (fixWidth(125)));
			normalTxtFont = Font.createFont(Font.TRUETYPE_FONT, new File("Pixellari.ttf"))
					.deriveFont((float) (fixWidth(60)));
			buttonFont = Font.createFont(Font.TRUETYPE_FONT, new File("Pixellari.ttf"))
					.deriveFont((float) (fixWidth(75)));
